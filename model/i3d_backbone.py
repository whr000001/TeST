...
class InceptionI3d(nn.Module):
    ...
    def __init__(self, in_channels, num_classes=400, spatial_squeeze=True,
                 final_endpoint='Logits', name='inception_i3d',
                 dropout_keep_prob=0.5):
        """Initializes I3D model instance.
        Args:
          num_classes: The number of outputs in the logit layer (default 400, which
              matches the Kinetics my_dataset).
        ...
        self.end_points[end_point] = Unit3D(in_channels=in_channels, output_channels=64,
                                            ...
                                            name=name + end_point, activation_fn=func.relu)
    ...
    def forward(self, x):
        for end_point in self.VALID_ENDPOINTS:
            if end_point in self.end_points:
                x = self._modules[end_point](x)  # use _modules to work with data_parallel
