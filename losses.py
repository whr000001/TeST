...
if __name__ == '__main__':
    output_dict = torch.load('out_sample.pt')
    ...
    # print(out_dict)
    # print(x)
    CPD_Loss = MultiSegmentLoss(21, 0, 1.0, use_focal_loss=True)
    ...
    print(loss_l, loss_c, loss_prop_l, loss_prop_c, loss_ct, loss_start, loss_end)
    # print(loss_start, loss_end)
    # scores_ = F.interpolate(scores, scale_factor=1.0 / 4)
    # print(output_dict['start_loc_prop'].shape)
    # print(scores.shape)
    # print(scores_)
    # print(loss_l, loss_c, loss_prop_l, loss_prop_c, loss_ct)
'''
